...
const char D_INTRO_1[] PROGMEM = "by magalhaes";
const char D_INTRO_2[] PROGMEM = DISPLAY_TEXT;
const char D_RESETTING[] PROGMEM = "Reiniciando...";
const char D_SCANNING_0[] PROGMEM = "> Escaneando";
const char D_SCANNING_1[] PROGMEM = "> Escaneando.";
const char D_SCANNING_2[] PROGMEM = "> Escaneando..";
const char D_SCANNING_3[] PROGMEM = "> Escaneando...";
